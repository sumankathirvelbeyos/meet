...
const WaterPage = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-end justify-end mx-auto p-[46px] md:px-10 sm:px-5 w-full">
        <div className="flex flex-col items-start justify-start mr-[18px] mt-2.5 w-[91%] md:w-full">
          ...
          <div className="flex sm:flex-col flex-row gap-[38px] items-center justify-start mt-11 w-[35%] md:w-full">
            <div
              className="bg-cover bg-no-repeat flex flex-col h-[142px] items-center justify-end p-[23px] sm:px-5 w-[38%] sm:w-full"
