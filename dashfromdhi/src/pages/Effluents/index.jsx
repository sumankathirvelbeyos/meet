  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-end justify-start mx-auto p-14 md:px-10 sm:px-5 w-full">
        <div className="flex flex-col items-start justify-start mb-1.5 mr-2">
          <div className="flex flex-row md:gap-10 items-start justify-between w-full">
            <Img
              className="h-[49px] md:h-auto mt-[21px] object-cover"
          ...
          <div className="flex md:flex-col flex-row gap-[45px] items-center justify-start mt-[88px] w-[95%] md:w-full">
            <div className="md:gap-5 gap-[60px] grid md:grid-cols-1 grid-cols-2 min-h-[auto] w-[55%] md:w-full">
              <div className="bg-gradient  flex flex-col justify-end p-[21px] sm:px-5 w-full">
                ...
                <Text
                  className="md:ml-[0] ml-[82px] mr-[54px] text-2xl md:text-[22px] text-white-A700 sm:text-xl w-[140px]"
