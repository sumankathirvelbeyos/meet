  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto p-[49px] md:px-10 sm:px-5 w-full">
        <div className="flex flex-col md:gap-10 gap-[91px] items-center justify-start max-w-[1303px] mb-[95px] mx-auto w-full">
          ...
          <div className="flex flex-col items-start justify-start w-[87%] md:w-full">
            ...
            <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between mt-11 w-full">
              <div className="flex md:flex-1 flex-col gap-11 items-start justify-start w-[39%] md:w-full">
                <div className="flex flex-col items-center justify-start w-[89%] md:w-full">
                  <div className="flex flex-row gap-[38px] items-center justify-between w-full">
                    <div
                      className="bg-cover bg-no-repeat flex flex-col h-[142px] items-center justify-start p-[30px] sm:px-5 w-[41%]"
                      style={{
                ...
                <div className="bg-light_green-100 flex flex-col items-center justify-start p-[53px] md:px-10 sm:px-5 w-full">
                  <Text
              ...
              <div className="md:flex-1 md:gap-5 gap-[60px] grid md:grid-cols-1 grid-cols-2 min-h-[auto] md:mt-0 mt-[186px] w-[56%] md:w-full">
            ...
            <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between mt-12 w-full">
              <div className="bg-light_green-100 flex md:flex-1 flex-col items-center justify-end p-[25px] sm:px-5 w-[39%] md:w-full">
              ...
              <div className="bg-light_green-100 flex md:flex-1 flex-col items-center justify-end p-[25px] sm:px-5 w-[56%] md:w-full">
            ...
            <div className="bg-gradient  flex sm:flex-col flex-row md:gap-10 items-start justify-between mt-[60px] p-3.5 w-full">
              <Text
                className="sm:ml-[0] ml-[22px] sm:mt-0 mt-[5px] md:text-3xl sm:text-[28px] text-[32px] text-white-A700"
                size="txtPoppinsBold32"
              >
                Average Training hours / Employee
              </Text>
              <Text
                className="mr-2.5 sm:mt-0 mt-[7px] md:text-3xl sm:text-[28px] text-[32px] text-white-A700"
                size="txtPoppinsBold32"
              >
            ...
            <div className="bg-light_green-100 flex flex-col items-center justify-end mt-[60px] p-[26px] sm:px-5 w-full">
              <div className="flex flex-col justify-start mt-3.5 w-[92%] md:w-full">
                <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[93%] md:w-full">
                  <div className="flex flex-col items-start justify-start md:mt-0 mt-2">
                    ...
                    <Text
                      className="mt-[54px] text-[13px] text-black-900 text-right"
                      size="txtPoppinsLight13"
                    >
                      2500
                    </Text>
                    ...
                    <Text
                      className="h-5 md:ml-[0] ml-[11px] mt-11 text-[13px] text-black-900 text-right"
                      size="txtPoppinsLight13"
                    >
                      100
                    </Text>
                  </div>
                  <Line className="bg-black-900 h-[322px] md:h-px md:ml-[0] ml-[23px] md:w-full w-px" />
            ...
            <div className="bg-gradient  flex sm:flex-col flex-row md:gap-10 items-center justify-between mt-[81px] p-3.5 w-full">
              <Text
              ...
              <Text
                className="mr-[62px] sm:mt-0 mt-[7px] md:text-3xl sm:text-[28px] text-[32px] text-white-A700"
                size="txtPoppinsBold32"
              >
                <span className="text-white-A700 font-poppins text-left font-bold">
                  10{" "}
            ...
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mt-3 w-full">
              <div className="flex md:flex-1 flex-col md:gap-10 gap-56 items-start justify-start md:mt-0 mt-14 w-[55%] md:w-full">
                <Text
                ...
                <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                  ...
                  <div className="bg-light_green-100 flex md:flex-1 flex-col h-[150px] items-center justify-end ml-4 md:ml-[0] p-[30px] sm:px-5 w-40 md:w-full">
                    <Text
                      className="p-[13px] text-5xl sm:text-[38px] md:text-[44px] text-light_green-800"
                      size="txtPoppinsBold48Lightgreen800"
                    >
                      300
                    </Text>
              ...
              <div className="flex md:flex-1 flex-col items-center justify-start md:mt-0 mt-[66px] w-[13%] md:w-full">
              ...
              <div className="flex md:flex-1 flex-col items-start justify-start md:ml-[0] ml-[26px] w-[31%] md:w-full">
                <div className="flex flex-row gap-4 items-center justify-between w-full">
                  ...
                  <div className="bg-light_green-100 flex flex-col h-[145px] items-start justify-start p-6 sm:px-5 w-[150px]">
                    <Text
                      className="md:ml-[0] ml-[21px] text-5xl sm:text-[38px] md:text-[44px] text-light_green-800"
                      size="txtPoppinsBold48Lightgreen800"
                    >
                      02
                    </Text>
                    <Text
                      className="mb-3 md:ml-[0] ml-[17px] text-black-900 text-xl"
                      size="txtPoppinsBold20"
                    >
                      MALES
                    </Text>
